	...
	<header id="top" class="header">
		<div class="topcorner">
			<form action="./gotoLoginProfile" method="GET">
				<a href="./gotoLoginProfile"> <img class="profile-img"
					src="http://bbsimg.ngfiles.com/2/4415000/ngbbs420f87bbdc87d.gif"
					alt="HTML5 Icon">
				</a> <label class="profile-name">${jobseeker.firstName}</label>
			</form>
		</div>
		<div id="profile_box">
			<div id="content" class="clearfix">
				...
				<section id="bio">
					...
					<i class="fa fa-pencil" aria-hidden="true">Add</i></a>
